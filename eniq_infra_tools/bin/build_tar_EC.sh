...
chmod 777 eniq_infra_tools/bin/build_rpm_EC
if [ "$Module" == "storage" ]
then
        perl eniq_infra_tools/bin/build_rpm_EC -r $Rstate -m ERICstmapi		
		perl eniq_infra_tools/bin/build_rpm_EC -r $Rstate -m ERICstmnas
        perl eniq_infra_tools/bin/build_rpm_EC -r $Rstate -m ERICstorapi
		mkdir rpm_files
		...
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r storage_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
				
elif [ "$Module" == "omtools" ]
then
		perl eniq_infra_tools/bin/build_rpm_EC -r $Rstate -m ERICkickstart
		mkdir rpm_files
		...
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r omtools_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		
elif [ "$Module" == "security" ]	
then
		perl eniq_infra_tools/bin/build_rpm_EC -r $Rstate -m ERICnodehardening
		mkdir rpm_files
		...
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r security_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
...
then
		...
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r bootstrap_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		
elif [ "$Module" == "EMC" ]
then
		cd om_linux/EMC
		sed -i "s/Rev/$Rstate/g" cxp_info
		createrepo /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/om_linux/EMC/x86_64
		tar -cvf EMC_$Rstate.tar ../EMC
		gzip EMC_$Rstate.tar
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r EMC_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files

elif [ "$Module" == "HWcomm" ]
then
		cd om_linux/HWcomm
		sed -i "s/Rev/$Rstate/g" cxp_info
		createrepo /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/om_linux/HWcomm
		tar -cvf HWcomm_$Rstate.tar ../HWcomm
		gzip HWcomm_$Rstate.tar
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r HWcomm_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
...
then
		...
		mkdir -p /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
		cp -r patch_$Rstate.tar.gz /home/lciadm100/jenkins/workspace/INFRA_KGB_Build_EC/tar_files
